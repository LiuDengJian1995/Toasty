...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_item_toast) {
            ...
            ToastyConfig.getInstance().setToastyView(new ItemToastyView());
        } else {
            //在ToastyConfig中设置吐司显示控件为空，则会显示默认的吐司显示控件（ToastyView）
            ToastyConfig.getInstance().setToastyView(null);
        }
        switch (v.getId()) {
            case R.id.btn_normal_toast:
                ToastyConfig.getInstance().setGravity(this, Gravity.CENTER);
            ...
            case R.id.btn_success_toast:
                ToastyConfig.getInstance().setGravity(this, Gravity.TOP);
//                ToastyShow.success(this,"This is success Toast", Toasty.LENGTH_SHORT);
            ...
            case R.id.btn_error_toast:
                ToastyConfig.getInstance().setGravity(this, Gravity.BOTTOM);
